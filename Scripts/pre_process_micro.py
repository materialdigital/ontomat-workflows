...
def pre_process_micro(input_json, input_json_path):
    """
    ...
    fiber_material_ID = input_json["micro"]["fiber"]["material_id"]
    fiber_mat = ontomat_query(fiber_material_ID)

    matrix_material_ID = input_json["micro"]["matrix"]["material_id"]
    ...
    material_json_path = sim_path + 'materials_micro.json'
    ...
    call_command = abq + \
        ' cae noGUI=generate_cae_micro.py -- {} {}'.format(
